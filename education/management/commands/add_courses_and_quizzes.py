...
from education.models import Course, Quiz, Choice  # Ajoute ici l'importation de Choice
...
#
#    def handle(self, *args, **kwargs):
#        # Données pour les cours et les quiz
#        courses_data = [
#            {
#                "title": "Introduction à la Gestion Financière",
#                "description": "Apprenez les bases de la gestion de votre argent.",
...
#                    {"question": "Que signifie le terme 'budget' ?", "answer": "Plan de dépenses"},                   {"question": "Que signifie le terme 'budget' ?", "answer": "Plan de dépenses"},
    ...
    #                {"question": "Que signifie 'intérêt composé' ?", "answer": "Intérêt sur intérêt"},
     #               {"question": "Qu'est-ce qu'un investissement ?", "answer": "Placement d'argent"},
      #              {"question": "Pourquoi diversifier ses investissements ?", "answer": "Réduction des risques"},
        ...
        # for index, course_data in enumerate(courses_data, start=1):  # Utiliser l'index pour l'ordre des cours
        #     # Créer ou récupérer le cours avec l'ordre
        #     course, created = Course.objects.get_or_create(
        #     title=course_data["title"],
        #     description=course_data["description"],
        #     is_unlocked=course_data["is_unlocked"],  # Utilise 'is_unlocked' au lieu de 'unlocked'
        #     order=index  # Utilisation de l'index pour l'ordre
        # )

        #     # Déverrouiller le premier cours
        #     if index == 1 and not course.is_unlocked:
        #         course.is_unlocked = True
        #         course.save()

        #     # Créer les quiz associés au cours
        #     for quiz_data in course_data["quizzes"]:
        #         # Ajouter un utilisateur par défaut pour les quiz
        #         quiz_data['user'] = user
